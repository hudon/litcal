...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        litdb_h.C_POINTER.withName("__routine"),
        litdb_h.C_POINTER.withName("__arg"),
        litdb_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = litdb_h.upcallHandle(__routine.Function.class, "apply", $DESC);
