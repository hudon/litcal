...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        litdb_h.C_INT.withName("tm_sec"),
        litdb_h.C_INT.withName("tm_min"),
        litdb_h.C_INT.withName("tm_hour"),
        litdb_h.C_INT.withName("tm_mday"),
        litdb_h.C_INT.withName("tm_mon"),
        litdb_h.C_INT.withName("tm_year"),
        litdb_h.C_INT.withName("tm_wday"),
        litdb_h.C_INT.withName("tm_yday"),
        litdb_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        litdb_h.C_LONG.withName("tm_gmtoff"),
        litdb_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
