...
describe('getCelebrations', () => {
  it('gets temporal celebrations in Advent', () => {
    assertGetsCelebrations([
      ...
      [[2025, 11, 5], 'Friday of the 1st Week of Advent'],
      // Gaudete Sunday
  ...
  it('gets temporal celebrations in Ordinary Time', () => {
    assertGetsCelebrations([
      [[2025, 0, 13], 'Monday of the 1st Week of Ordinary Time'],
      // First Sunday of OT1
      [[2025, 0, 19], '2nd Sunday of Ordinary Time'],
      [[2025, 2, 4], 'Tuesday of the 8th Week of Ordinary Time'],
      // First day of OT2
      [[2025, 5, 10], 'Tuesday of the 10th Week of Ordinary Time'],
      ...
      [[2021, 6, 25], '17th Sunday of Ordinary Time'],
      [[2025, 7, 31], '22nd Sunday of Ordinary Time'],
      [[2025, 10, 29], 'Saturday of the 34th Week of Ordinary Time']
    ])
  })
  ...
  it('gets temporal celebrations in Lent', () => {
    assertGetsCelebrations([
      ...
      [[2025, 2, 15], 'Saturday of the 1st Week of Lent'],
  ...
  it('gets temporal celebrations in Paschal Triduum', () => {
    assertGetsCelebrations([
      ...
      [[2023, 3, 8], 'The Easter Vigil in the Holy Night']
    ])
  })
  ...
  it('gets temporal celebrations in Easter', () => {
    const expects = [
      ...
      [[2025, 4, 29], 'Thursday of the 6th Week of Easter'],
  ...
  it('gets all days of 2025 correctly', () => {
    ...
    for (let [key, val] of Object.entries(data2025)) {
      ...
      // TODO test the other celebrations for the day
      assert.equal(res[0].name, val[0].name)
      assert.equal(res[0].rank, val[0].rank, `${val[0].name} rank mismatch`)
    }
  })
  ...
  it('demotes StJames feast for Sunday on 20210725', () => {
    ...
    assert.equal(res.length, 1)
    assert.equal(res[0].name, '17th Sunday of Ordinary Time')
  })
})
