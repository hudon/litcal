...
// Transform the JLCAPI calendar output so that it becomes test data for us (like a snapshot test)
...
function main() {
  ...
  for (const ev of events) {
    ...
    let name = ev.name.replace(', Mother of', ', the Holy Mother of')
      ...
      .replace('The 1st Martyr', 'the First Martyr') // correcting the overcorrection... whatever
      ...
      .replace('Blessed Kateri', 'Saint Kateri')
      .replace('Sharbel Makhluf, Hermit', 'Sharbel Makhlūf, Priest')
      .replace(', virgin', ', Virgin')
      .replace('The Beheading of Saint John the Baptist, Martyr', 'The Passion of Saint John the Baptist')
      .replace('Exaltation', 'The Exaltation')
      .replace('Priest, and Paul', 'Priest, Paul')
      .replace('Saint Andrew Kim', 'Saints Andrew Kim')
      .replace('Gabriel and Raphael', 'Gabriel, and Raphael')
      .replace("all the Faithful Departed (All Souls' Day)", 'All the Faithful Departed')
      .replace('Christ the King', 'Our Lord Jesus Christ, King of the Universe')
      .replace('Thanksgiving', 'Thanksgiving Day')
      .replace(', Patronal feastday of the United States of America', '')
      .replace('Blessed Virgin Mary of Loreto', 'Our Lady of Loreto')
      .replace('Lucy of Syracuse', 'Lucy')
      .replace(' (Gaudete)', '')
      .replace(/^Christmas$/, 'The Nativity of the Lord')
      .replace('Holy Family of Jesus, Mary and Joseph', 'The Holy Family of Jesus, Mary, and Joseph')
      .replace('Day of the Octave', 'Day within the Octave')
    ...
    else if (name.includes('Kateri')) rank = 10
    else if (name.includes('Thanksgiving')) rank = 12
    else if (name.includes('Immaculate Conception')) rank = 4
    else if (name.includes('Week of Advent') && date.getUTCDate() >= 17) {
      rank = 9
    } else if (name.includes('within the Octave of Christmas')) rank = 9
